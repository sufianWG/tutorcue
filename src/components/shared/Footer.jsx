...
import { FaEnvelope, FaHeart, FaPhone } from "react-icons/fa6";
...
const Footer = () => {
    ...
    return (
        <div className="bg-[var(--surface)] text-[var(--secondary)] shadow-md">
            <footer className="container mx-auto py-4 px-6 flex flex-col items-center justify-between gap-3">
                ...
                <div className="footerCopyRight text-[var(--secondary)]/60 w-full flex flex-col lg:flex-row justify-between items-center gap-3 mt-4 border-t border-[var(--secondary)]/40 pt-4 ">
