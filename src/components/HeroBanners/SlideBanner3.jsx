...
const SlideBanner3 = () => {
    return (
        <div className='bg-[var(--surface-alt)]'>
            <div className='max-w-6xl mx-auto py-10 lg:py-15 px-8 md:px-12 lg:px-0 lg:px-0 lg:min-h-screen flex flex-col md:flex-row items-center justify-start md:justify-between gap-10'>
                <div className="space-y-4">
                    ...
                    <h1 className='text-[var(--secondary)] text-3xl sm:text-4xl lg:text-5xl font-bold'>Learn Anytime, <br /> <span className='text-[var(--primary)]'>Anywhere</span></h1>
                ...
                <div className="lg:mb-0 relative">
                    ...
                    <div className="static md:absolute md:-top-20 lg:-top-20 md:-left-30 lg:right-0 lg:w-fit flex flex-col items-center md:items-start bg-[var(--surface)] shadow-lg p-4 rounded-md mx-4 lg:">
