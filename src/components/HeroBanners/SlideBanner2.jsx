        ...
        <div className='bg-tc-surface-alt'>
            <div className='max-w-6xl mx-auto py-10 lg:py-15 px-8 md:px-12 lg:px-14 lg:min-h-screen flex flex-col md:flex-row items-center justify-start md:justify-between gap-10'>
                <div className="space-y-4">
                    <h3 className="text-tc-primary text-xs font-bold uppercase bg-tc-muted/10 px-4 py-2 rounded-full w-fit flex items-center gap-2"> <SiKnowledgebase size={15} /> Learn Smarter, Not Harder</h3>
                    <h1 className='text-tc-secondary text-3xl sm:text-4xl lg:text-5xl font-bold'>Expert Tutors <br /> <span className='text-tc-primary'>Better Results.</span></h1>
                    <p className="text-tc-muted text-base md:w-2/3 lg:w-full">Connect with verified tutors who are passionate
                    ...
                    <div className="mt-6 flex flex-col md:flex-row gap-4 md:gap-8 text-tc-secondary text-sm font-bold">
                        <div className="flex items-center gap-2"> <span className="bg-tc-primary/30 text-tc-secondary p-2 rounded-full"> <FaUser size={18} /> </span>  Verified Tutors </div>
                        <div className="flex items-center gap-2"> <span className="bg-tc-primary/30 text-tc-secondary p-2 rounded-full"> <FaGraduationCap size={18} /> </span> Personalized Learning </div>
                ...
                <div className="lg:mb-0 relative">
                    ...
                    <div className="relative md:absolute md:-top-20 lg:-top-2 md:-left-35 flex md:-left-10 flex-col items-center md:items-start">
                        ...
                        <div className="w-fit flex items-center gap-4 justify-center lg:justify-start bg-tc-surface shadow-lg rounded-lg p-4 mt-6 lg:mt-0">
                            <div className="bg-tc-primary/30 text-tc-secondary p-2 rounded-full"><FaStar size={24} /></div>
                            <div>
